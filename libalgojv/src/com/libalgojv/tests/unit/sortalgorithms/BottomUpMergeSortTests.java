...
class BottomUpMergeSortTests {
    ...
    @Test
    void sortArray() {
        BottomUpMergeSort.sort(sortedArray);
        assertTrue(Sortable.isSorted(sortedArray));

        BottomUpMergeSort.sort(unsortedArray);
        assertTrue(Sortable.isSorted(unsortedArray));

        BottomUpMergeSort.sort(reverseSortedArray);
    ...
    void sortExample() {
        ...
        BottomUpMergeSort.sort(sortExampleActual);
    ...
    void stableSortExample() {
        ...
        BottomUpMergeSort.sort(sortExampleStableActual);
